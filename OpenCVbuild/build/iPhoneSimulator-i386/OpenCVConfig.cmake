...
set(OpenCV_INCLUDE_DIRS "/Users/Administrator/Development/AR/OpenCVbuild/build/iPhoneSimulator-i386" "/Users/Administrator/Development/AR/OpenCV/include" "/Users/Administrator/Development/AR/OpenCV/include/opencv")
...
set(OpenCV_LIB_DIR_OPT "/Users/Administrator/Development/AR/OpenCVbuild/build/iPhoneSimulator-i386/lib" CACHE PATH "Path where release OpenCV libraries are located")
set(OpenCV_LIB_DIR_DBG "/Users/Administrator/Development/AR/OpenCVbuild/build/iPhoneSimulator-i386/lib" CACHE PATH "Path where debug OpenCV libraries are located")
set(OpenCV_3RDPARTY_LIB_DIR_OPT "/Users/Administrator/Development/AR/OpenCVbuild/build/iPhoneSimulator-i386/3rdparty/lib" CACHE PATH "Path where release 3rdpaty OpenCV dependencies are located")
set(OpenCV_3RDPARTY_LIB_DIR_DBG "/Users/Administrator/Development/AR/OpenCVbuild/build/iPhoneSimulator-i386/3rdparty/lib" CACHE PATH "Path where debug 3rdpaty OpenCV dependencies are located")
...
SET(OpenCV_LIB_COMPONENTS opencv_world;opencv_core;opencv_imgproc;opencv_flann;opencv_highgui;opencv_features2d;opencv_video;opencv_photo;opencv_calib3d;opencv_videostab;opencv_objdetect;opencv_nonfree;opencv_stitching;opencv_ml;opencv_softcascade;opencv_legacy;opencv_contrib)

set(OpenCV_opencv_world_LIBNAME_OPT "libopencv_world.a")
set(OpenCV_opencv_world_DEPS_OPT zlib)
set(OpenCV_opencv_world_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_core_LIBNAME_OPT "libopencv_core.a")
set(OpenCV_opencv_core_DEPS_OPT zlib)
set(OpenCV_opencv_core_EXTRA_DEPS_OPT stdc++)
set(OpenCV_opencv_imgproc_LIBNAME_OPT "libopencv_imgproc.a")
set(OpenCV_opencv_imgproc_DEPS_OPT zlib;opencv_core)
set(OpenCV_opencv_imgproc_EXTRA_DEPS_OPT stdc++)
set(OpenCV_opencv_flann_LIBNAME_OPT "libopencv_flann.a")
set(OpenCV_opencv_flann_DEPS_OPT zlib;opencv_core)
set(OpenCV_opencv_flann_EXTRA_DEPS_OPT stdc++)
...
set(OpenCV_opencv_highgui_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_features2d_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_video_LIBNAME_OPT "libopencv_video.a")
set(OpenCV_opencv_video_DEPS_OPT zlib;opencv_core;opencv_imgproc)
set(OpenCV_opencv_video_EXTRA_DEPS_OPT stdc++)
set(OpenCV_opencv_photo_LIBNAME_OPT "libopencv_photo.a")
set(OpenCV_opencv_photo_DEPS_OPT zlib;opencv_core;opencv_imgproc)
set(OpenCV_opencv_photo_EXTRA_DEPS_OPT stdc++)
...
set(OpenCV_opencv_calib3d_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_videostab_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_objdetect_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_nonfree_LIBNAME_OPT "libopencv_nonfree.a")
set(OpenCV_opencv_nonfree_DEPS_OPT zlib;opencv_core;opencv_imgproc;opencv_flann;opencv_highgui;opencv_features2d;opencv_calib3d)
set(OpenCV_opencv_nonfree_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_stitching_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_ml_LIBNAME_OPT "libopencv_ml.a")
set(OpenCV_opencv_ml_DEPS_OPT zlib;opencv_core)
set(OpenCV_opencv_ml_EXTRA_DEPS_OPT stdc++)
set(OpenCV_opencv_softcascade_LIBNAME_OPT "libopencv_softcascade.a")
set(OpenCV_opencv_softcascade_DEPS_OPT zlib;opencv_core;opencv_imgproc;opencv_ml)
set(OpenCV_opencv_softcascade_EXTRA_DEPS_OPT stdc++)
...
set(OpenCV_opencv_legacy_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_contrib_EXTRA_DEPS_OPT stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_world_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_core_LIBNAME_DBG "libopencv_core.a")
set(OpenCV_opencv_core_DEPS_DBG zlib)
set(OpenCV_opencv_core_EXTRA_DEPS_DBG stdc++)
set(OpenCV_opencv_imgproc_LIBNAME_DBG "libopencv_imgproc.a")
set(OpenCV_opencv_imgproc_DEPS_DBG zlib;opencv_core)
set(OpenCV_opencv_imgproc_EXTRA_DEPS_DBG stdc++)
set(OpenCV_opencv_flann_LIBNAME_DBG "libopencv_flann.a")
set(OpenCV_opencv_flann_DEPS_DBG zlib;opencv_core)
set(OpenCV_opencv_flann_EXTRA_DEPS_DBG stdc++)
...
set(OpenCV_opencv_highgui_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_features2d_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_video_LIBNAME_DBG "libopencv_video.a")
set(OpenCV_opencv_video_DEPS_DBG zlib;opencv_core;opencv_imgproc)
set(OpenCV_opencv_video_EXTRA_DEPS_DBG stdc++)
set(OpenCV_opencv_photo_LIBNAME_DBG "libopencv_photo.a")
set(OpenCV_opencv_photo_DEPS_DBG zlib;opencv_core;opencv_imgproc)
set(OpenCV_opencv_photo_EXTRA_DEPS_DBG stdc++)
...
set(OpenCV_opencv_calib3d_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_videostab_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_objdetect_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_nonfree_LIBNAME_DBG "libopencv_nonfree.a")
set(OpenCV_opencv_nonfree_DEPS_DBG zlib;opencv_core;opencv_imgproc;opencv_flann;opencv_highgui;opencv_features2d;opencv_calib3d)
set(OpenCV_opencv_nonfree_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_stitching_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
set(OpenCV_opencv_ml_LIBNAME_DBG "libopencv_ml.a")
set(OpenCV_opencv_ml_DEPS_DBG zlib;opencv_core)
set(OpenCV_opencv_ml_EXTRA_DEPS_DBG stdc++)
set(OpenCV_opencv_softcascade_LIBNAME_DBG "libopencv_softcascade.a")
set(OpenCV_opencv_softcascade_DEPS_DBG zlib;opencv_core;opencv_imgproc;opencv_ml)
set(OpenCV_opencv_softcascade_EXTRA_DEPS_DBG stdc++)
...
set(OpenCV_opencv_legacy_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
set(OpenCV_opencv_contrib_EXTRA_DEPS_DBG stdc++;-framework\ AVFoundation;-framework\ QuartzCore;-framework\ Accelerate;-framework\ CoreGraphics;-framework\ CoreImage;-framework\ CoreMedia;-framework\ CoreVideo;-framework\ AssetsLibrary)
...
# ==============================================================
SET(OpenCV2_INCLUDE_DIRS /Users/Administrator/Development/AR/OpenCV/modules/core/include;/Users/Administrator/Development/AR/OpenCV/modules/imgproc/include;/Users/Administrator/Development/AR/OpenCV/modules/flann/include;/Users/Administrator/Development/AR/OpenCV/modules/highgui/include;/Users/Administrator/Development/AR/OpenCV/modules/features2d/include;/Users/Administrator/Development/AR/OpenCV/modules/calib3d/include;/Users/Administrator/Development/AR/OpenCV/modules/ml/include;/Users/Administrator/Development/AR/OpenCV/modules/video/include;/Users/Administrator/Development/AR/OpenCV/modules/objdetect/include;/Users/Administrator/Development/AR/OpenCV/modules/contrib/include;/Users/Administrator/Development/AR/OpenCV/modules/legacy/include;/Users/Administrator/Development/AR/OpenCV/modules/nonfree/include;/Users/Administrator/Development/AR/OpenCV/modules/photo/include;/Users/Administrator/Development/AR/OpenCV/modules/softcascade/include;/Users/Administrator/Development/AR/OpenCV/modules/stitching/include;/Users/Administrator/Development/AR/OpenCV/modules/videostab/include;/Users/Administrator/Development/AR/OpenCV/modules/world/include)
